/*
	...
	Also fixes the "Vehicle Lost Owner info" the BIS Garbage Collecter is tricked by accessing the Variables over and over again.
...
_vehNotAllowed = ["I_UGV_01_rcws_F","I_APC_Wheeled_03_cannon_F","I_MRAP_03_gmg_F","I_UAV_02_CAS_F","I_MBT_03_cannon_F","I_APC_tracked_03_cannon_F","I_Plane_Fighter_03_AA_F","I_Plane_Fighter_03_CAS_F","O_UGV_01_rcws_F","O_MRAP_02_gmg_F","O_UAV_02_CAS_F","O_UAV_02_F","O_MBT_02_arty_F","O_MBT_02_cannon_F","O_APC_Tracked_02_AA_F","O_APC_Tracked_02_cannon_F","O_Plane_CAS_02_F","O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","O_Heli_Light_02_F","B_UAV_01_F"];
...
{
	{
		...
		if ( _typeof in _vehNotAllowed ) then {
			...
			////diag_log format["OBS - NPC VEHICLE TYPE DETECTED!!!: %1", _typeof];
