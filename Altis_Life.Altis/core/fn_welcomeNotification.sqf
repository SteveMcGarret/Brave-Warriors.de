...
switch (playerSide) do
{
	case west: 
	{
        _text = [
			...
			format ["<t align='left'>Wenn das dein erster Besuch auf unserem Server ist, bitten wir dich, die Regeln genauestens durchzulesen.</t>"],
			format ["<t align='left'>Herzlich Willkommen im Altis Life Police Department. Rüste dich aus und mache den Verbrechern ANGST.</t>"],
			...
			format ["<t align='left' color='#428BCA'>TS3 : Zombie-City.de</t>"],
			format ["<t align='left' color='#428BCA'>Viel Spaß wünschen Steve McGarrett, FlyFly und das gesamte Team</t>"]
		];
	};
	case independent:
	{
