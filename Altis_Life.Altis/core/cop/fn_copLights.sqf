...
switch (typeOf _vehicle) do
{
	...
	case "O_MRAP_02_F":					{			_lightleft lightAttachObject [_vehicle, [-0.37, -1.9, 0.7]];	};
	case "O_MRAP_02_hmg_F":				{			_lightleft lightAttachObject [_vehicle, [-0.37, -1.9, 0.7]];	};
...
switch (typeOf _vehicle) do
{
	...
	case "O_MRAP_02_F":					{ 			_lightright lightAttachObject [_vehicle, [0.37, -1.9, 0.7]];	};
	case "O_MRAP_02_hmg_F":				{ 			_lightright lightAttachObject [_vehicle, [0.37, -1.9, 0.7]];	};
