...
life_gang_ravensquad = ["76561198127982644",
"76561198040100744",
"76561198048206542",
"76561198121823813",
"76561198077690574",
...
__CONST__(life_gang_oob,life_gang_oob);
__CONST__(life_gang_ava,life_gang_ava);
__CONST__(life_gang_bwu,life_gang_bwu);
...
life_sirenLightVehicles = ["B_Truck_01_box_F","B_Truck_01_transport_F","B_Truck_01_covered_F","C_Van_01_box_F","C_Offroad_01_F","B_MRAP_01_F","B_MRAP_01_hmg_F","C_SUV_01_F","O_MRAP_02_F","O_MRAP_02_hmg_F","B_MRAP_01_hmg_F","B_APC_Wheeled_01_cannon_F", "I_MRAP_03_F","I_MRAP_03_hmg_F","I_Heli_light_03_unarmed_F","C_Hatchback_01_sport_F"];
...
switch (playerSide) do
{
	...
	case civilian: 
	{
		...
		if((getPlayerUID player) in __GETC__(life_gang_adac) ) then {
			life_atmcash = 15000; //Starting Bank Money
			life_paycheck = 9500; //Paycheck Amount
		};
