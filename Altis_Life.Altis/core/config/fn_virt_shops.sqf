...
switch (_shop) do
{
	...
	case "rebel": {["Rebel Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","blastingcharge","storagesmall","storagebig","zipties","underwatercharge"]]};
	case "gang": {["Gang Market", ["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","blastingcharge","boltcutter","storagesmall","storagebig","zipties","underwatercharge"]]};
	case "shadow": {["SD Markt", ["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","blastingcharge","boltcutter","storagesmall","storagebig","zipties","underwatercharge"]]};
	...
	// MORE JOBS CONFIG
	case "adac": {["ADAC Item Shop",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","lockpick","pursuit"]]};
