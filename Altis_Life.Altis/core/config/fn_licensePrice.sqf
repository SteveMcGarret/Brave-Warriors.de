...
switch (_type) do
{
	...
	case "pilot": {125000}; //Pilot/air license cost
	...
	case "heroin": {112000}; //Heroin processing license cost
	case "marijuana": {110000}; //Marijuana processing license cost
	case "medmarijuana": {1500}; //Medical Marijuana processing license cost
	case "gang": {10000}; //Gang license cost
	case "rebel": {180000}; //Rebel license cost
