...
_ret set[count _ret,["U_BG_Guerilla2_1","Police Uniform",25]];
_ret set[count _ret,["U_BG_Guerilla2_2","Police Uniform 2",25]];
};
...
_ret set[count _ret,["U_O_Wetsuit",nil,1500]];
};
};
